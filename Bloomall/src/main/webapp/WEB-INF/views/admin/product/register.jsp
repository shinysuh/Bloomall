...
<script type="text/javascript" src="/js/admin/product/register.js"></script>
...
// ckEditor
    ...
    // 취소 버튼(btnCancel) - 클릭하고 한번 confirm("상품등록을 취소하시겠습니까?")
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="box box-primary">
							...
							<form id="regiForm" role="form" action="/admin/product/registerOk" method="post" enctype="multipart/form-data">
								<div class="box-body">
									<div class="form-group">
										...
										<select class="form-control" id="primaryCategory" name="ctgr_prt_cd" style="width:30%; margin-right:10px; display: inline-block;" >
										  ...
										  <c:forEach items="${ctgrList}" var="list">
										  	<option value="${list.ctgr_cd}">${list.ctgr_name}</option>
										  </c:forEach>
										</select>
									...
									<div class="form-group">
										...
										<input type="text" id="prd_author" name="prd_author" class="form-control "
											placeholder="Enter Author name" style="width:40%; display: inline-block;" />
									</div>
									<div class="form-group">
										<label for="prd_company" >출판사</label>
										<input type="text" id="prd_company" name="prd_company" class="form-control"
											placeholder="Enter company" style="width:81%;">
									</div>
									<div class="form-group">
										...
										<input type="text" id="prd_dc_price" name="prd_dc_price" class="form-control "
											placeholder="Enter discounted price" style="width:40%; display: inline-block;" />
									</div>
									<div class="form-group">
										<label for="prd_detail">상세정보</label>
										<textarea class="form-control" id="prd_detail" name="prd_detail" rows="8" placeholder="Enter ..."></textarea>
									</div>
