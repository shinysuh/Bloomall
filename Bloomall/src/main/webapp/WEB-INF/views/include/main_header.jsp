...
<header class="main-header">
	...
	<!-- Logo -->
	<a href="/" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels --> <span class="logo-mini">
			<b>BLOOMALL</b>
		</span>
		<!-- logo for regular state and mobile devices --> 
		<span class="logo-lg">BLOOMALL</span>
	</a>
			...
			<ul class="nav navbar-nav">
				...
				<c:if test="${sessionScope.user == null }">
					<li class="dropdown user user-menu">
						<a href="/member/join"><span class="hidden-xs">회원가입</span></a>
					</li>
					<li class="dropdown user user-menu">
					...
					<li class="user user-menu">
						<a href="/member/myPage" class="toggle" >
				...
				<c:if test="${sessionScope.user != null }">
					<li class="dropdown user user-menu">
						<p class="hidden-xs" style="color:white; margin-top:14px;">최근접속: 
							<fmt:formatDate value="${sessionScope.user.mem_last_visit }" pattern="yyyy-MM-dd"/>
						&nbsp;&nbsp;&nbsp;&nbsp;</p>
					</li>
					<li class="dropdown user user-menu">
						<p class="hidden-xs" style="color:white; margin-top:14px;"><b>${sessionScope.user.mem_nick }</b>님 
						</p>
					</li>
					<li class="dropdown user user-menu">
						<a href="/member/logout"><span class="hidden-xs">로그아웃</span></a>
					</li>
					<li class="user user-menu">
						<a href="/order/orderHistory" class="toggle">
						  <span class="hidden-xs">주문내역</span>
