			...
			<ul class="nav navbar-nav">
				...
				<c:if test="${sessionScope.admin == null }">
					<li class="dropdown user user-menu">
						<a href="/admin/main"><span class="hidden-xs">로그인 하기</span></a>
					</li>
				</c:if>
				...
				<c:if test="${sessionScope.admin != null }">
					<li class="dropdown user user-menu">
						<p class="hidden-xs" style="color:white; margin-top:14px;">최근접속: 
							<fmt:formatDate value="${sessionScope.admin.ad_last_visit }" pattern="yyyy-MM-dd HH:mm"/>
						&nbsp;&nbsp;&nbsp;&nbsp;</p>
					</li>
					<li class="dropdown user user-menu">
						<p class="hidden-xs" style="color:white; margin-top:14px;"><b>${sessionScope.admin.ad_name }</b>님 
						</p>
					</li>
					<li class="dropdown user user-menu">
