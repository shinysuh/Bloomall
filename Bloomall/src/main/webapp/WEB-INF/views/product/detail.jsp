										...
										<div class="col-sm-8">
											...
											<div class="col-xs-5" style="background-color:rgb(216, 216, 216);width:39%;">
												<div style="margin-top: 25px;">
													<div class="form-group">
														<div class="stars">
												         	<label><i id="star1"></i></label>
												        	<label><i id="star2"></i></label>
												        	<label><i id="star3"></i></label>
														...
														<div class="rvwCount">
															판매지수 <span style="color:red;">${vo.ord_amount }</span>
															<span class='divi'>&nbsp;|&nbsp;</span>
															회원리뷰 (<a href="#" class="toRvw" id="r_count">${vo.rvw_count}</a>건) <!-- 클릭시 리뷰 앵커 / 펼쳐짐 기능 js-->
														</div>
													</div>
